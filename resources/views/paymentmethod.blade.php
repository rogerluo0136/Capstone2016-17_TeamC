...
@section('content')
	...
	<div class="container">
		<div class="panel panel-default padder col-md-10">
			<div class="row ">
				<div class="col-xs-12 ">
	    ...
	    token: function(token) {
	    	...
	    	$.ajax({
		      	...
		      	data:{
		      		...
		      		@if(!is_null($program_season))
					      	program_season: {!! $program_season !!},

					      @else
					      	program_season: 'music assessment',
		...
		$(function() {
			$('#fileuploader').submit( function(e){
				...
				@if(!is_null($program_season))
			      ...
			      @else
			      	formData.append( 'program_season', 'music assessment' );
